...
################################################################################
   ...
   script_version='v0.1'
    ...
    recode php7.3-sqlite3 php7.3-tidy php7.3-xmlrpc php7.3-xsl memcached php-imagick php-php-gettext php7.3-zip php7.3-mbstring \
    ...
    # Compil Blocknotify
    cd ~
    git clone -b PHP8.3 https://github.com/craiglyoung/yiimp-cly.git
